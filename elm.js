...
var $author$project$Main$assetPrefix = '/littlemakings/assets/';
...
var $author$project$Main$viewGallery = function (urls) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$onPage = F2(
	function (model, link) {
		return _Utils_eq(model.url.path, link);
	});
var $author$project$Main$headerIcon = F3(
	function (model, url, link) {
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					...
					'border-bottom',
					A2($author$project$Main$onPage, model, link) ? '1px solid #555' : '0'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '1px')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Main$viewLogo = A2(
	...
	_List_fromArray(
		[
			...
			A2($elm$html$Html$Attributes$style, 'text-decoration', 'none'),
			A2($elm$html$Html$Attributes$style, 'color', 'black'),
			A2($elm$html$Html$Attributes$style, 'font', 'normal normal normal 1rem cookie,cursive')
		]),
	_List_fromArray(
		[
			$elm$html$Html$text('littlemakings')
		]));
var $author$project$Main$viewHeader = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'background-color', 'rgb(227, 179, 202)'),
		...
		_List_fromArray(
			[
				...
				A3($author$project$Main$headerIcon, model, $author$project$Main$assetPrefix + 'bow.svg', '/littlemakings/bows'),
				A3($author$project$Main$headerIcon, model, $author$project$Main$assetPrefix + 'canvas.svg', '/littlemakings/canvas'),
				A3($author$project$Main$headerIcon, model, $author$project$Main$assetPrefix + 'sign.svg', '/littlemakings/signs')
			]));
};
var $author$project$Main$viewBows = function (model) {
	return _List_fromArray(
		[
...
var $author$project$Main$viewBanner = F3(
	function (url, title, pageUrl) {
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'background', 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),' + ('url(\'' + (url + '\')'))),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'font-size', '3.5rem'),
...
var $author$project$Main$viewFullLogoBanner = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'width', '100vw'),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$src($author$project$Main$assetPrefix + 'car.mp4')
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'height', '100%'),
					A2($elm$html$Html$Attributes$style, 'width', '100%'),
					A2($elm$html$Html$Attributes$style, 'font', '3.5rem cookie, cursive'),
					A2($elm$html$Html$Attributes$style, 'color', 'rgb(227, 179, 202)'),
...
var $author$project$Main$pages = _List_fromArray(
	[
		{title: 'Home', url: '/littlemakings/main', view: $author$project$Main$viewHome},
		{title: 'Bows', url: '/littlemakings/bows', view: $author$project$Main$viewBows},
		{title: 'Canvas', url: '/littlemakings/canvas', view: $author$project$Main$viewCanvas},
		{title: 'Signs', url: '/littlemakings/signs', view: $author$project$Main$viewSigns}
	]);
				...
				A2(
					...
					$elm$core$List$head(
						A2(
							...
							function (page) {
								return _Utils_eq(page.url, model.url.path);
							},
